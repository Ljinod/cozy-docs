...
> *Alice*: That's it?<br />
> *Cozy*: Yup, that's all the information you need to send a request. :-)
...
please take a loot at the corresponding documentation: [how to add
permissions](https://docs.cozy.io/en/hack/getting-started/play-with-data-system.html).
As we said in the dialogue above, to share an application needs the permissions
called **sharing**.
